...
### API Changes
- **Shopper Search API**: Add `includedCustomVariationProperties` query parameter to the `productSearch` operation and `expand` query parameter to the `getSearchSuggestions` operation
